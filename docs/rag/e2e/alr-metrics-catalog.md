...
| Failure taxonomy | `charts.failureTaxonomy` | donut по `allurerc.json` categories |
...
- Native Allure dynamics — iframe dashboard plugin (`allurerc.json`), не дублировать без причины
